...
mkdir(dir_path);
global k_stepness ;
copyfile('fvalues.m','design6/fvalues.m')
copyfile('Design_plotter.m','design6/Design.m')
copyfile('Design_plotter.ipynb','design6/Des_plot.ipynb')
...
copyfile('test.m','design6/test.m')