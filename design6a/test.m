...
mkdir(dir_path);
global c_extend ;
copyfile('fvalues.m','design6a/fvalues.m')
copyfile('Design_plotter.m','design6a/Design.m')
copyfile('Design_plotter.ipynb','design6a/Des_plot.ipynb')
wave=[1528.5 1529.0 1529.5 1530 1530.5 1531.0 1531.5]*1e-9+20e-9;
%wave=1550e-9; 
for j_profile=30.5:-2:10.5,
    c_extend=j_profile;
for i=1:length(wave),
...
copyfile('test.m','design6a/test.m')