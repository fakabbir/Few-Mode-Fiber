...
mkdir(dir_path);
global k_stepness ;
copyfile('fvalues.m','design2/fvalues.m')
copyfile('Design_plotter.m','design2/Design.m')
copyfile('Design_plotter.ipynb','design2/Des_plot.ipynb')
...
copyfile('test.m','design2/test.m')
