...
global c_extend ;
global r_power;
copyfile('fvalues.m','design6b/fvalues.m')
copyfile('Design_plotter.m','design6b/Design.m')
copyfile('Design_plotter.ipynb','design6b/Des_plot.ipynb')
wave=[1528.5 1529.0 1529.5 1530 1530.5 1531.0 1531.5]*1e-9+20e-9;
%wave=1550e-9; 
for j_profile=2:0.2:5,
    c_extend = 22.5;
    r_power = j_profile;
for i=1:length(wave),
...
copyfile('test.m','design6b/test.m')