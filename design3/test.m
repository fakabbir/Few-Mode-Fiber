...
mkdir(dir_path);
global k_stepness ;
copyfile('fvalues.m','design3/fvalues.m')
copyfile('Design_plotter.m','design3/Design.m')
copyfile('Design_plotter.ipynb','design3/Des_plot.ipynb')
...
copyfile('test.m','design3/test.m')
